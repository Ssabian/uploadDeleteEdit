  ...
  <div class="container">
    <div class="content">
      ...
      $result=mysqli_query($conn,$query);
        ...
        echo  "<li><img src=" . $row["photo"] . ">";
        echo  "<div class='panel-overlay'>";
        echo  "<h2>" . $row["lead"] . "</h2>";
        echo   $row["desca"] . "<br />";
        echo  "<a href='#'>Continue Reading &raquo;</a>";
        echo   "</div>";
        echo   "</li>";
          }
          ?>
    ...
    <div class="column">
      <ul class="latestnews">
        <li><img src="images/demo/100x100.gif" alt="" />
          <p><strong><a href="#"></a></strong> Nullamlacus dui ipsum cons eque loborttis non euis que morbi penas dapibulum orna. Urnaultrices quis curabitur phasellentesque.</p>
        </li>
        <li><img src="images/demo/100x100.gif" alt="" />
